...
if take == 1:
	...
	path = raw_input().strip()   
		...
		max_score = -max(log_likelihood)
    	winner = np.argmax(log_likelihood)
    	print "\tDetected as - \"{}\" \n\tlog_likehood prediction is: {}".format(speakers[winner], max_score)
...
print "Speaker identified Sucessfull. \n This is a very very fist version, we will improve soon in next version !!!"
